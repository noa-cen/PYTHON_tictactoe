...
def intro():
    print("Bienvenue sur le Tic Tac Toe de Noa !")
    print("\n")
    print("Règles du jeu: joueur 1 et joueur 2, représentés par X et O, "
          "choisissent une case à tour de rôle. ")
    print("Le premier qui réussit à aligner trois X ou trois O verticalement, "
          "horizontalement ou en diagonale, gagne la partie. ")
    print("Le choix de la case se fait sous format 'A3', 'B1', 'C2'...")
    print("\n")
    print("Let's play !")
    print("\n")
    input("Touchez entrée pour continuer.")

# Ask player to choose their sign
def choose_sign(): 
    sign1 = input("Choix du signe (X ou O): ")
...
# Check 8 possibilities of victory and return true or false
